...
describe("school name", () => {
  it("should set school name based off of user input from question prompt", () => {
    ...
    const intern = new Intern("Nick", 456, "test@gmail.com", school);
...
describe("getRole", () => {
  it("should get employee type ", () => {
    ...
    const intern = new Intern("Nick", 123, "someEmail@gmail.com");
...
describe("getSchool", () => {
  it("should get school name from object", () => {
    ...
    const intern = new Intern("Nick", 123, "someEmail@gmail.com", school);
